    ...
    <div class="welcome-message">
        <div class="wrap-info">
            <div class="information">
                <h1  class="animated fadeInDown">selamat datang di hotel melinda</h1>
                <p class="animated fadeInUp">hotel paling mewah di indonesia dengan perawatan dan layanan yang sangat baik.</p>                
            </div>
...
<div class="col-sm-7 col-md-8">
    <div class="embed-responsive embed-responsive-16by9 wowload fadeInLeft"><iframe  class="embed-responsive-item" src="images/hotel.png" width="100%" height="400" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></div>
</div>
